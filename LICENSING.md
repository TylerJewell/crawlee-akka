...
A `LICENSE-crawlee` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [apify/crawlee](https://github.com/apify/crawlee), Copyright
2018 Apify Technologies s.r.o, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../crawlee-port/specs/SPEC-001-crawlee.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
